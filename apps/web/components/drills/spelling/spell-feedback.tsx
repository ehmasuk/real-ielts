    ...
    >
      {isCorrect ? (
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-2xl font-medium text-emerald-600 dark:text-emerald-400 mb-2">
            {correctAnswer}
          </p>
          <p className="text-sm text-muted-foreground">
            Excellent! You spelled it correctly.
          </p>
        </div>
      ) : (
        <div className="flex flex-col items-center w-full max-w-sm">
          ...
          <h3 className="text-3xl font-bold text-foreground tracking-tight mb-8">Incorrect</h3>
          
          <div className="w-full grid grid-cols-2 gap-4 mb-6">
            <div className="flex flex-col items-center p-4 rounded-2xl bg-destructive/5 border border-destructive/10">
              <span className="text-[10px] uppercase tracking-wider font-semibold text-destructive/70 mb-1">Your Answer</span>
              <span className="text-lg font-semibold text-destructive line-through decoration-destructive/50">{userAnswer}</span>
            </div>
            <div className="flex flex-col items-center p-4 rounded-2xl bg-emerald-500/5 border border-emerald-500/10">
              <span className="text-[10px] uppercase tracking-wider font-semibold text-emerald-600/70 mb-1">Correct Answer</span>
              <span className="text-lg font-semibold text-emerald-600">{correctAnswer}</span>
            </div>
          </div>
