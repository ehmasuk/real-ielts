    ...
    <div className="space-y-8">
      ...
      <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-4 space-y-2">
        ...
        <ul className="text-[11px] text-amber-600/80 dark:text-amber-400/80 space-y-1 list-disc list-inside">
          ...
          <li><code className="text-[10px] font-mono">notes_completion</code>, <code className="text-[10px] font-mono">table_completion</code>, and <code className="text-[10px] font-mono">form_completion</code> use <code className="text-[10px] font-mono">layout</code> instead of <code className="text-[10px] font-mono">questions[]</code>; each cell is an <strong>array</strong> of inline <code className="text-[10px] font-mono">text</code> and <code className="text-[10px] font-mono">question</code> items</li>
