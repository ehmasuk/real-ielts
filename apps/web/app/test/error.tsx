  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 p-8">
      ...
      <div className="text-center">
        <h1 className="text-xl font-bold text-foreground">Test Error</h1>
        <p className="mt-1 text-sm text-muted-foreground">Something went wrong during the test. Your progress may not be affected.</p>
      </div>
      <button
        onClick={reset}
